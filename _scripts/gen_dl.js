...
const EXTRA = {
  ...
  'perspective-donella-meadows': ['meadows', '梅多斯', 'donella'],
  'perspective-kevin-kelly': ['kelly', 'kk', '凯利', '凯文凯利'],
  'perspective-norbert-wiener': ['wiener', '维纳', 'norbert'],
  'perspective-christopher-alexander': ['alexander', '亚历山大', 'christopher'],
  'perspective-hans-rosling': ['rosling', '罗斯林', 'hans'],
  'perspective-joseph-campbell': ['campbell', '坎贝尔', 'joseph'],
